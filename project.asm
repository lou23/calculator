...
.DEF  DIG_THREE=R24
.DEF  DIG_ANS = R25 ;storage for the answer
.DEF  TEN = R29 ; register for multiplying by 10
.DEF  TEMP1   = R26  ; temporary working register
.DEF ASCII=R27 ;Register for storing the ASCII value
...
Display:
   ;out   PORTB, TEMP   ; set LEDs with value in TEMP
   call LCD
   ret
...
serial_out:
   ...
   ror SER_REG1      ; rotate carry into B7
   out PORTB, SER_REG1    ;output B4
   call B_DELAY
   ror SER_REG      ; rotate B5 into carry
   ror SER_REG1      ; rotate carry into B7
   out PORTB, SER_REG1    ;output B5
   call B_DELAY
